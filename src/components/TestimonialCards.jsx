...
const testimonials = [
  ...
  {
    id: 2,
    testimonial: "Human and AI Alignment on Stance Detection: A Case Study of the United Healthcare CEO Assassination. We used LLMs and human annotation to detect stance toward Luigi Mangione in public discourse on X, and I developed interactive BERTopic visualizations to explore topic modeling results from 10K+ tweets.",
    author: "Alina Hagen, Daniel Tafmizi, Christopher Reddish, Loni Hagen, Ashley Fox, Nic DePaula",
...
export default function TestimonialCards() {
  const [positions, setPositions] = useState(["front", "middle"])
