...
const TABS = [
  { id: "water", label: "Water Rates", icon: "💧", color: C.water },
  { id: "electric", label: "Electric Reliability", icon: "⚡", color: C.electric },
  { id: "ai", label: "AI Agent", icon: "🤖", color: C.ai },
  { id: "stack", label: "Methods", icon: "◈", color: C.green },
];
